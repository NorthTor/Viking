...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MCUBOOT_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MCUBOOT_LOG_LEVEL, 0);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_NRF9160DK_NRF9160, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FXL6408_LOG_LEVEL, 0);
